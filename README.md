...
Dalam proyek prediksi harga mobil dengan menggunakan Regresi Linear, metrik evaluasi yang saya gunakan digunakan adalah Root Mean Square Error (RMSE) dan R-squared (R^2). <br>
 ...
 Dalam proyek ini, RMSE sebesar 0.0438 (atau sekitar 4.38%) menunjukkan bahwa model memiliki kesalahan rata-rata sekitar 4.38% dalam memprediksi harga mobil.<br>    
 ```python
...
- **R-squared (R^2)**<br>
Dalam proyek ini, R^2 sebesar 0.824, yang berarti model Anda mampu menjelaskan sekitar 82.4% dari variabilitas harga mobil. Ini menunjukkan bahwa model ini memiliki kemampuan yang baik dalam menjelaskan variasi dalam harga mobil.
